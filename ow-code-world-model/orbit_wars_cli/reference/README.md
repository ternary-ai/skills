# Ternary Capital — Orbit Wars Reference

Game specification and observation reference for the Orbit Wars environment.
Used as the benchmark environment for Ternary's Code World Model and search-based agent research.
